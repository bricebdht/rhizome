...
export default tseslint.config(
  ...
  // shadcn primitives are generated by its CLI and re-generated on update.
  // They export their `cva` variants next to the component, which trips the
  // fast-refresh ergonomics rule. Splitting the files by hand would create
  // merge friction on every regeneration for no runtime benefit.
  {
